...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\parici\PycharmProjects\northsideDJs (current)\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\parici\PycharmProjects\northsideDJs (current)\venv\Scripts\deactivate.nu'
